...
// Each game card carries a data-filter-conference attribute (e.g. "Big North|NJIC"),
...
//   e.g. node scripts/scrape-scores.js 2025-10-15 "Big North"
//        node scripts/scrape-scores.js              (defaults to yesterday, Big North)
//
...
(async () => {
    ...
    const confArg = process.argv[3] || 'Big North';
    const confRe = new RegExp(confArg.replace(/[-\s]+/g, '.?'), 'i');   // "Big North" ~ "Big-North"
