// Build data/schedule.json - every Big North Conference game we can reach,
...
//
// Covers all 41 member schools on DigitalSports (ds-schools.json).
// All schools confirmed on DigitalSports as of 2026-08; update ds-schools.json
...
// No Big North schools are known to use iCal feeds - all 41 are on DigitalSports.
...
// No Big North schools are on ArbiterLive - all 41 use DigitalSports.
...
async function main() {
    ...
    fs.writeFileSync(OUT, JSON.stringify({
        _comment: 'Generated by scripts/build-schedule.js - do not edit by hand. Covers all 41 Big North member schools on DigitalSports. Games only - practices are filtered out. Sorted by date then start time, de-duplicated so a fixture listed by both schools appears once. Cancelled games are kept and carry status.',
