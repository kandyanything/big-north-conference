// Conference standings: NJ.com publishes the BNC tables, so each sport links
        ...
        .then(function (data) {
            ...
            seasons.forEach(function (s) {
                ...
                s.sports.forEach(function (sp) {
                    ...
                    // clickable - no BNC table is published for it yet.
                    if (!sp.slug && !sp.url) {
                    ...
                    a.href = sp.url || (data.baseUrl + '/' + sp.slug + '/standings/season/' +
                             ...
                             (sp.conference || data.defaultConference || 'BNC'));
                    a.target = '_blank';
                    a.rel = 'noopener';
