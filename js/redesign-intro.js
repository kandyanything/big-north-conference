...
// balls (each landing with a squash-and-settle), then flips into the Big North
...
// 41 SCHOOLS - ONE CONFERENCE" fades in. Finally the crest flies up and docks
...
(function () {
    ...
    var logo = img('images/bnc-logo-footer.png');
    ...
    function wordmark(alpha) {
        ...
        ctx.fillText('41 SCHOOLS · ONE CONFERENCE', cx, cy + R * 2.4);
